...
\subsection{Hauptansicht}
    ...
    \subsubsection{InformationWidget} \label{sec:InformationWidget}
        \paragraph*{Attribute}
            \subparagraph*{information: InformationCategories} - Gibt an, welche Information in dem Widget dargestellt werden soll.
            \subparagraph*{text: string} - Der Text, der in dem Widget angezeigt werden kann.

        \paragraph*{Methoden}
            \subparagraph*{InformationWidget(information: InformationCategories - notNull, text: string)} - Konstruktor für Information Widget. Eine Information Kategorie muss angegeben werden.
    ...
    \subsubsection{SortingMethods}
        ...
        \paragraph*{Content}
            ...
            \subparagraph*{difficulty} - Die Rezepte werden nach dem \glslink{schwierigkeit}{Schwierigkeitsgrad} sortiert.
            \subparagraph*{date} - Die Rezepte werden nach dem Hinzufügedatum sortiert.
...
\subsection{Gruppen-Detail-Ansicht}
    ...
    \subsubsection{GroupDetailPage}
        ...
        \paragraph*{Methoden}
            \subparagraph*{GroupDetailPage(group: Group - notNull)} - Ein Konstruktor für GroupDetailPage. Der Parameter muss angegeben werden. 
            \subparagraph*{setGroupTitle(newTitle: string)} - Die Eingabe wird überprüft und die Funktion setGroupName() im GroupService wird aufgerufen.
            \subparagraph*{deleteGroup()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion kickUser() im GroupService aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
            \subparagraph*{leaveGroup()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion leaveGroup() im GroupService wird aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
    ...
    \subsubsection{ConfirmationWidget}
        ...
        \paragraph*{Methoden}
            \subparagraph*{ConfirmationWidget(text: string - notNull)} - Ein Konstruktor für ConfirmationWidget, bei dem ein Text angegeben werden muss.
            \subparagraph*{decline()} - Dem Erzeuger wird true zurückgegeben.
            \subparagraph*{accept()} - Dem Erzeuger wird false zurückgegeben.
    ...
    \subsubsection{OptionWidget}
        ...
        \paragraph*{Methoden}
            \subparagraph*{OptionWidget(user: User - notNull)} - Ein Konstruktor für OptionWidget. Der Parameter muss angegeben werden. 
            \subparagraph*{kickUser()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion kickUser() im UserSettingsService aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
            \subparagraph*{banUser()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion banUser() im UserSettingsService aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
            \subparagraph*{makeAdmin()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion makeAdmin() im UserSettingsService aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
            \subparagraph*{removeAdminStatus()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion removeAdminStatus() im UserSettingsService aufgerufen. Bei negativer Rückmeldung ändert sich nichts.
    ...
    \subsubsection{RecipeWidget}
        ...
        \paragraph*{Methoden}
            \subparagraph*{RecipeWidget(recipe: Recipe - notNull, view: boolean - notNull, settingsView: boolean - notNull)} - Ein Konstruktor für RecipeWidget. Alle Parameter müssen angegeben werden.
    ...
    \subsubsection{UserWidget}
        ...
        \paragraph*{Methoden}
            \subparagraph*{UserWidget(user: User - notNull, isOwnAccount: bool - notNull)} - Ein Konstruktor für UserWidget. Alle Parameter müssen angegeben werden.
  ...
  \subsection{Rezept-Erstellungs-Ansicht}
    ...
    \subsubsection{RecipeCreationPageState}
        \paragraph*{Attributes}
            ...
            \subparagraph*{title: TextEdittingController (notNull)} - Die eingegebene Zeichenkette für den Titel des Rezepts. Die Zeichenkette kann maximal 64 Zeichen lang sein und darf nicht leer sein.
