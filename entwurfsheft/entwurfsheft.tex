...
\subsection{Hauptansicht}
    ...
    \subsubsection{InformationElement} \label{sec:InformationElement}
        ...
        \paragraph*{Methoden}
            \subparagraph*{InformationElement(information: InformationKategories - notNull, text: string)} - Der Konstruktor für ein Information Widget. Eine Information Kategorie muss angegeben werden.
