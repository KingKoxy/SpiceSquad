...
\subsection{Id Token}
Ein Id Token ist eine Stunde gültig, neue Id Tokens können vom Firebase-Server angefordert werden. Ein Id Token wird benötigt, um eine aktive Nutzersession zu validieren.
