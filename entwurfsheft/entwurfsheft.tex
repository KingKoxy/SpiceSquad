...
\end{figure}
\subsubsection*{Attribute}
\paragraph{\texttt{showSkip: bool}}
Wenn der Boolean wahr ist, wird oben rechts ein Überspringen-Knopf angezeigt, der zur Hauptansicht (\ref{sec:mainScreen}) leitet. Er wird bei der Initialisierung des Widgets aus dem \Gls{BuildContext} gelesen, oder auf falsch gesetzt, wenn dort kein Wert eingetragen ist.
