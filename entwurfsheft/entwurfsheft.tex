...
\subsection{Häufig verwendete Klassen}
    ...
    \subsubsection{InformationCategories} \label{sec:InformationCategories}
        ...
        \subsubsection*{Content}
            ...
            \paragraph*{\texttt{difficultyEasy}} Das Widget gibt den \glslink{schwierigkeit}{Schwierigkeitsgrad} einfach an.
            \paragraph*{\texttt{difficultyMedium}} Das Widget gibt den \glslink{schwierigkeit}{Schwierigkeitsgrad} mittel an.
            \paragraph*{\texttt{difficultyHard}} Das Widget gibt den \glslink{schwierigkeit}{Schwierigkeitsgrad} schwer an.
