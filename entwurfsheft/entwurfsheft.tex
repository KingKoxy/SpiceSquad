...
\subsection{Verwaltungsansicht}
    ...
    \subsubsection{SettingsPageState}
        ...
        \paragraph*{Methoden}
            ...
            \subparagraph*{recipeCreationView()} - Die Rezept-Erstellungs-Ansicht wird aufgerufen.
            \subparagraph*{deleteAccount()} - Das ConfirmationWidget wird aufgerufen und bei positiver Rückmeldung wird die Funktion kickUser() im UserSettingsService wird aufgerufen. Bei negativer Rückmeldung ändert sich nichts. 
