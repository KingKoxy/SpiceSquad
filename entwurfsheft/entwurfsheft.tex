...
\newpage
\subsection{\texttt{IngredientService}}\label{sec:ingredientservice}
...
\newpage
\subsection{\texttt{AdminService}}\label{sec:adminservice}
...
\newpage
\subsection{\texttt{ProviderFactory}}\label{sec:providerfactory}
...
\subsubsection{AppBar} \label{sec:AppBar}\label{sec:AppBar}
\subsubsection*{Attribute}
...
\subsubsection{AbstractRouter}\label{sec:AbstractRouter}
...
\paragraph{checkAuthorization: CheckAuthorization} % TODO
\paragraph{checkAuth: any} % TODO Datentyp

\subsubsection*{Methoden}
\paragraph{<<create>> constructor(): void}
Konstruktor der Klasse \texttt{AbstractRouter}. Wir zum erzeugen des Objekts benötigt.
