...
\paragraph{Response}
Im Erfolgsfall wird ein Statuscode 200 und der \glslink{JWT}{JWT} des Nutzers zurückgegeben.
...
Anfragen an diese Route müssen mit einem gültigen \glslink{JWT}{JWT} versehen sein, da nur angemeldete Nutzer Rezepte erstellen können.
Der \glslink{JWT}{JWT} wird dabei im Header der Anfrage mitgeschickt.
...
Die Anfragen an diese Route müssen mit einem gültigen \glslink{JWT}{JWT} versehen sein, da nur angemeldete Nutzer Gruppen erstellen können.
Der \glslink{JWT}{JWT} wird dabei im Header der Anfrage mitgeschickt.
...
Die Anfragen an diese Route müssen mit einem gültigen \glslink{JWT}{JWT} versehen sein, da nur angemeldete Nutzer Nutzerdaten ändern können.
Der \glslink{JWT}{JWT} wird dabei im Header der Anfrage mitgeschickt.
