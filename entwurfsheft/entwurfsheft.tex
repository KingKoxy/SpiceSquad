...
\subsection{Hauptansicht}
    ...
    \subsubsection{InformationWidget} \label{sec:InformationWidget}
        ...
        \paragraph*{Methoden}
            \subparagraph*{InformationWidget(information: InformationCategories - notNull, text: string)} - Konstruktor für ein Information Widget. Eine Information Kategorie muss angegeben werden.
...
\subsection{Gruppen-Erstellungs-Ansicht}
    ...
    \subsubsection{GroupCreationPageState}
        ...
        \paragraph*{Methoden}
            ...
            \subparagraph*{createGroup(name: string)} - Überprüft den Gruppenname und ruft die Funktionen createGroup() im GroupService auf.
