...
\label{sec:ingredientPickerWidget}
...
Leitet eine Anfrage zum Aktivieren/Deaktivieren der Zensur eines Rezepts über einen Provider an den zugehörigen Service weiter.
\newpage
...
\subsubsection*{POST /auth/login}
    ...
    \paragraph{Response}
        Im Erfolgsfalls wird der Statuscode 200 und der \glslink{idToken}{idToken} des Nutzers zurückgegeben.
