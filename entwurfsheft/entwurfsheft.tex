...
Die Klasse bildet die Rezept-Erstellungsansicht ab. Sie ist ein \texttt{StatelessWidget}, da sie keinen Zustand verwaltet. Dies übernehmen die einzelnen Teilwidgets. Es werden verschiedene Widgets angezeigt, die es ermöglichen Rezeptdaten einzugeben oder abzuändern.
\subsubsection*{Attribute}
\paragraph{\texttt{recipe: Recipe}}
...
\subsection{\texttt{ingredient\_picker\_screen}}
