...
\subsection{Hauptansicht}
    ...
    \subsubsection{AppBar} \label{sec:AppBar}
        ...
        \paragraph*{Methode}
            \subparagraph*{AppBar(required mainView: Boolean ,required recipeCreationView: Boolean ,required settingsView: Boolean )} Der Konstruktor für den AppBar. Alle Parameter müssen angegeben werden. 
    ...
    \subsubsection{InformationElement} \label{sec:InformationElement}
        ...
        \paragraph*{Methode}
            \subparagraph*{InformationWidget(required information: InformationCategories , text: string)} Konstruktor für Information Widget. Eine Information Kategorie muss angegeben werden.
...
\subsection{Gruppen-Detail-Ansicht}
    ...
    \subsubsection{GroupDetailPage}
        ...
        \paragraph*{Methode}
            \subparagraph*{GroupDetailPage(required group: Group)} Ein Konstruktor für eine GroupDetailPage. Der Parameter muss angegeben werden. 
    ...
    \subsubsection{ConfirmationElement} \label{sec:ConfirmationElement}
        ...
        \paragraph*{Methode}
            \subparagraph*{ConfirmationElement(required text: string)} Ein Konstruktor für ein ConfirmationElement, wobei ein Text angegeben werden muss.
    ...
    \subsubsection{OptionElement}
        ...
        \paragraph*{Methode}
            \subparagraph*{OptionElement(required user: User)} Ein Konstruktor für ein OptionElement. Der Parameter muss angegeben werden. 
    ...
    \subsubsection{RecipeElement} \label{sec:RecipeElement}
        ...
        \paragraph*{Methode}
            \subparagraph*{RecipeElement(required recipe: Recipe,required view: boolean,required settingsView: boolean)} Ein Konstruktor für ein RecipeElement. Alle Parameter müssen angegeben werden.
    ...
    \subsubsection{UserElement} 
        ...
        \paragraph*{Methode}
            \subparagraph*{UserElement(required user: User,required isOwnAccount: bool)} Ein Konstruktor für ein UserElement. Alle Parameter müssen angegeben werden.
    ...
    \subsection{Rezept-Erstellungs-Ansicht}
        ...
        \subsubsection{Difficulty}
            ...
            \paragraph*{Content}
                \subparagraph*{easy} Der \glslink{schwierigkeit}{Schwierigkeitsgrad} einfach.
                \subparagraph*{medium} Der \glslink{schwierigkeit}{Schwierigkeitsgrad} mittel.
                \subparagraph*{hard} Der \glslink{schwierigkeit}{Schwierigkeitsgrad} schwer.
...
\subsection{Verwaltungsansicht}
    ...
    \subsubsection*{GroupElement}
        ...
        \paragraph*{Methode}
            \subparagraph*{GroupElement(required group: Group)} Der Konstruktor für ein GroupElement. Der Parameter muss angegeben werden.
...
\subsection{QR-Code-Ansicht}
    ...
    \subsubsection{QrCodePage}
        ...
        \paragraph*{Methode}
            \subparagraph*{QrCodePage(required group: Group)} Der Konstruktor für eine QrCodePage. Der Parameter muss angegeben werden.
