...
\begin{enumerate}[start=1,label={$\langle$\bfseries RM\arabic*$\rangle$}, leftmargin = 5em, itemsep=4pt, parsep=4pt]
    ...
    \item Der Nutzer muss einer Gruppe mithilfe eines \glslink{gruppenkürzel}{Gruppenkürzels} beitreten können und diese danach auch wieder verlassen können.\label{rm:GroupJoining}
...
\begin{enumerate}
    ...
    \item Der Nutzer gibt das \glslink{gruppenkürzel}{Gruppenkürzels} ein.
