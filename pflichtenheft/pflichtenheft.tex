...
\begin{enumerate}[start=1,label={$\langle$\bfseries RM\arabic*$\rangle$}, leftmargin = 5em, itemsep=4pt, parsep=4pt]
    ...
    \item In jeder Gruppe muss mindestens ein Gruppenadministrator sein.\label{RM5}
...
\begin{enumerate}[start=1,label={$\langle$\bfseries RS\arabic*$\rangle$}, leftmargin = 5em, itemsep=4pt, parsep=4pt]
    ...
    \item Ein \Gls{administrator} soll weiter Gruppenmitglieder zum Administrator ernennen können und jenen auch den Adminstatus wieder entziehen können.\label{RS3}
...
Der Abschnitt Abbildung 3.2 und Abbildung 3.3 werden genauer in jeweils einem Aktivitätsdiagramm abgebildet.
...
Der Administrator muss in der Verwaltungs-Ansicht die Gruppe wählen in der er Gruppenadmin ist.
...
\begin{enumerate}
    ...
    \item Der Nutzer klickt auf die Detail-Ansicht eines Mitglieds der Gruppe.
    \item Der Nutzer klickt auf die Option den Nutzer die Administratoren Rechte der Gruppe zu entziehen.
