...
\begin{enumerate}[start=1,label={$\langle$\bfseries RM\arabic*$\rangle$}, leftmargin = 5em, itemsep=4pt, parsep=4pt]
    ...
    \item In jeder Gruppe muss mindestens ein \Gls{administrator} sein.\label{RM5}
    ...
    \item Der Nutzer muss Rezepte von anderenen nutzern in der gleichen Gruppe anschauen können.\label{RM8}
...
\begin{enumerate}[start=1,label={$\langle$\bfseries RS\arabic*$\rangle$}, leftmargin = 5em, itemsep=4pt, parsep=4pt]
    ...
    \item Ein Administrator soll weiter Gruppenmitglieder zum Administrator ernennen können und jenen auch den Adminstatus wieder entziehen können.\label{RS3}
    \item Ein Administrator soll Nutzer aus Gruppen kicken und bannen können.\label{RS4}
    \item Ein Administrator soll Rezepte von anderen Nutzern in der Gruppe ausblenden können.\label{RS5}
    ...
    \item Jedes Gruppenmitglied soll das Gruppenkürzel auch über einen QR-Code teilen können.\label{RS10}
...
\subsection*{Aufbau der App (Abbildung 3.1)}
...
\subsection*{Hauptansicht (Abbildung 3.2)}
...
\subsection*{Gruppen-Detail-Ansicht als Administrator (Abbildung 3.3)}
...
\begin{figure}[!htp]
    ...
    Abbildung 3.2: Aktivitätsdiagramm: Hauptansicht
    \label{fig:A32}
\end{figure}
\newpage
...
\begin{figure}[!htp]
    ...
    \end{adjustbox}
    Abbildung 3.3: Aktivitätsdiagramm: Gruppen-Detail-Ansicht als Administrator
    \label{fig:A33}
\end{figure}
\newpage
...
\textbf{Administrator ernennen und Administrator Status entfernen $\langle$F140$\rangle$}\\
...
%Todo entbannen noch aktuell oder entfernen?
...
\textbf{Vorbedingung:} Der Nutzer ist Administrator der Gruppe und in der Gruppe bestehen Rezepte.\\
