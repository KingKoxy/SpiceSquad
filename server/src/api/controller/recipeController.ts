...
export default class RecipeController extends AbstractController {
     ...
     */
    public async recipePost(req: express.Request, res: express.Response, next: express.NextFunction): Promise<void> {
     ...
     * @returns Promise<void>
     */
    public async recipeDelete(req: express.Request, res: express.Response, next: express.NextFunction): Promise<void> {
     ...
     * @returns Promise<void>
     */
    public async recipePatch(req: express.Request, res: express.Response, next: express.NextFunction): Promise<void> {
     ...
     * @returns Promise<void>
     */
    public async recipeReport(req: express.Request, res: express.Response, next: express.NextFunction): Promise<void> {
