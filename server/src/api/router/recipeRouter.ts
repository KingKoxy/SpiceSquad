...
import {recipeCreateSchema, recipeDeleteSchema, recipeGetAllSchema, recipeReportSchema, recipeSetFavorite, recipeUpdateSchema} from "../../schemas/recipeSchema";
...
export default class RecipeRouter extends abstractRouter {
  ...
  */
  ...
  protected setupRoutes(): void {
    this.router.post(
      "/",
      this.checkAuth, this.schemaValidator.checkSchema(recipeCreateSchema),
      this.Controller.recipePost.bind(this.Controller)
    );
    this.router.get(
      "/:userId",
      this.checkAuth, this.schemaValidator.checkSchema(recipeGetAllSchema),
      this.Controller.recipesGetAllForUser.bind(this.Controller)
    );
    this.router.delete(
      "/:productId",
      this.checkAuth, this.schemaValidator.checkSchema(recipeDeleteSchema),
      this.Controller.recipeDelete.bind(this.Controller)
    );
    this.router.patch(
      "/:productId",
      this.checkAuth, this.schemaValidator.checkSchema(recipeUpdateSchema),
      this.Controller.recipePatch.bind(this.Controller)
    );
    this.router.patch(
      "/setFavorite/:productId",
      this.checkAuth, this.schemaValidator.checkSchema(recipeSetFavorite),
      this.Controller.recipeSetFavorite.bind(this.Controller)
    );
    this.router.post(
      "/report/:productId",
      this.checkAuth, this.schemaValidator.checkSchema(recipeReportSchema),
